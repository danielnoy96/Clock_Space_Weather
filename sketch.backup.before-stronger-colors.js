...
const COL = {
  ...
  xray:      [210, 70, 255],  // vivid violet
  mag:       [30, 210, 255],  // bright cyan
  h_ions:    [40, 95, 255],   // deep blue
  electrons: [40, 255, 120],  // neon green
  protons:   [255, 160, 40],  // warm orange
};
...
function seedChamberParticles(T, count) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    let size = 1.6;
    if (kind === "xray") size = 1.7;
    else if (kind === "electrons") size = 1.6;
    else if (kind === "mag") size = 1.6;
    else if (kind === "h_ions") size = 1.55;
    else if (kind === "protons") size = 1.6;
...
function emitFromHand(T, which, rate) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    if (kind === "mag")       { size = 1.6; }
    if (kind === "h_ions")    { size = 1.55; }
    if (kind === "protons")   { size = 1.6; }
